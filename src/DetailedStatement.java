...
public class DetailedStatement extends JFrame implements ActionListener {
	...
	public DefaultTableModel fill_table() throws SQLException {
		...
		String q_minist = "SELECT * FROM transaction LIMIT" + Integer.toString(ms_r);
